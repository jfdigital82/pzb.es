...
function handleChange(checkbox, n) {
...
function validateForm() {
  ...
  var x, y, i, countcheck, valid = false;
  countcheck = $(".multisteps_form_panel").find("li.active").length;
  ...
  if(countcheck > 0){
    valid = true;
    $(".multisteps_form_panel").find("li.active").remove();
  } else {
    $(".message").show();
  }
